...
import img1 from "../ProductDetails/assets/YvesSaintLaurent/img1.jpg";
import img2 from "../ProductDetails/assets/YvesSaintLaurent/img2.jpeg";
import img3 from "../ProductDetails/assets/YvesSaintLaurent/img3.jpg";
import img4 from "../ProductDetails/assets/YvesSaintLaurent/img4.jpg";
import v1 from "../ProductDetails/assets/YvesSaintLaurent/v1.mp4";
import logofl from "../ProductDetails/assets/08AC2B4C-ED91-41DD-BD0C-24D31259E835.png";
import Footer from "../../components/Footer";
import { Link } from "react-router-dom";

const YvesSaintLaurent = () => {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  return (
      ...
      <div className='mx-auto px-[1em] pt-0'>
        <div className='mt-[60px]'>
          <div className='pt-[4em]'>
            <h1 className='pt-0 pb-[0.5em] projecttitle'>Yves Saint Laurent</h1>
          </div>
          <div>
            <p className='description_projets text-center static lg:px-[12em] md:px-[8em] sm:px-[4em] xsm:px-[2em]'>
            L'harmonie des formes, le souffle de l'audace, Yves Saint Laurent Beauté, créateur de légendes révèle le monde avec splendeur, dans ce film en motion design 2D.
            </p>
          </div>
        </div>
          ...
          <div className='main-works bg-cover relative'>
            ...
            <div className='page-nextdiv absolute text-white'>
              ...
              <div className='chapters-next_title-wrap'>
                <h4 className='chapters-next_title'>Gayelord Hauser / TV</h4>
...
export default YvesSaintLaurent;